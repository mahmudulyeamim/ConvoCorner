        ...
        <div className="w-full items-center flex">
            <div className="w-full justify-between items-center inline-flex">
                <div className="items-center flex">
                    <img className="rounded-lg w-16 h-16" alt="Ronald image" src="https://img.freepik.com/free-photo/book-composition-with-open-book_23-2147690555.jpg" />
                    <div className="flex-col inline-flex ml-2.5">
                        <h2 className={`text-sm font-semibold leading-snug ${active == room?.id ? "text-black" : "text-white"}`}>{room?.name}</h2>
                        <h6 className={`text-xs font-normal leading-4 ${active == room?.id ? "text-black" : "text-gray-100"}`}>Topic : {room?.topic}</h6>
                    </div>
                </div>
